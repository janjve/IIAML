...
while True:
    ...
    # Get the coordinates of the iris candidates.
    iris = [None] * 3
    if pupils[2] != -1:
        pupilCenter = pupils[1][pupils[2]]
        pupilRadius = pupils[0][pupils[2]][1][1]
        iris = detector.getIris(frames, pupilCenter, pupilRadius)
